...
public class Rectangle2DTest {
	...
	public void clones() throws CloneNotSupportedException {
		...
		Assert.assertThat(region1.equals(region2),
				CoreMatchers.is(Boolean.TRUE));
		Assert.assertThat(region1.getClass().equals(region2.getClass()),
				CoreMatchers.is(Boolean.TRUE));
		Assert.assertThat(region1.hashCode(),
				CoreMatchers.is(region2.hashCode()));
	}
}
